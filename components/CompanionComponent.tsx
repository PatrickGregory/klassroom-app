...
const CompanionComponent = ({ companionId, userName, name, style, voice, userImage, topic, subject }: CompanionComponentProps) => {
    ...
    useEffect(() => {
        ...
        const onCallEnd = () => {
            ...
            // add to session history with a specified ID
    ...
    return (
        <section className='flex flex-col h-[70vh]'>
            ...
            <section className="transcript mt-30">
